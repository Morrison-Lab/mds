...
# mds (Math for Data Science)

<!-- badges: start -->
<!-- badges: end -->

`mds` collects the mathematics that data science courses assume:
notation, algebra, calculus, linear algebra and vector calculus, as
...
``` sh
git clone --recurse-submodules https://github.com/Morrison-Lab/mds.git
quarto preview
```
